...
```
We see that the estimated log hazard ratio for treatment ( beta^hat(trt) = -0.49) is about the samw as the "true" log hazard ratio used in the simple model (beta^hat(trt) = -0.50).  The estimated baseline hazard rate is exp(−5.54) = 0.0039, which is almost equal to the baseline hazard rate used in simple model. 
