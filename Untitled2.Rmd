...
```
 ...
 #trying the area-specific intercept and a area-specific coefficient for
the covariate treatment

```{r}
mod_randtrt <- update(mod_randint_HC_weibull, formula. = Surv(month_next_preg,event_next_preg_24) ~treatment + (treatment | area_bl))
```
